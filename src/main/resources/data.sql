...
INSERT INTO Answer (answer_id, question_question_id, writer_id, contents, date, deleted) VALUES ('1', '1', '3', '자바가 짱입니다', CURRENT_TIMESTAMP, 'false');
INSERT INTO Answer (answer_id, question_question_id, writer_id, contents, date, deleted) VALUES ('2', '2', '3', '힘들어도 해야지 인마', CURRENT_TIMESTAMP, 'false');
INSERT INTO Answer (answer_id, question_question_id, writer_id, contents, date, deleted) VALUES ('3', '2', '1', '힘들어도 해야지 인마', CURRENT_TIMESTAMP, 'false');